...
//
///////////////////////////////////////////
Shader "TPCi/Boards/Metal/Metal_Mask_Dissolve" {
Properties {
_T_VFX_Metal_Hex_Mask ("T_VFX_Metal_Hex_Mask", 2D) = "white" { }
_tex4coord ("", 2D) = "white" { }
_texcoord ("", 2D) = "white" { }
__dirty ("", Float) = 1
}
...
#define UNITY_BINDING(x) layout(std140)
#endif
uniform 	vec4 _T_VFX_Metal_Hex_Mask_ST;
UNITY_LOCATION(0) uniform mediump sampler2D _T_VFX_Metal_Hex_Mask;
...
void main()
{
    u_xlat0.xy = vs_TEXCOORD0.xy * _T_VFX_Metal_Hex_Mask_ST.xy + _T_VFX_Metal_Hex_Mask_ST.zw;
    u_xlat16_0 = texture(_T_VFX_Metal_Hex_Mask, u_xlat0.xy).x;
