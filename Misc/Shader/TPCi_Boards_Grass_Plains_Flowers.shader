...
//
///////////////////////////////////////////
Shader "TPCi/Boards_Grass_Plains_Flowers" {
Properties {
_Max ("Max", Float) = 0.01
...
void main()
{
    ...
    u_xlat2.xy = vs_TEXCOORD1.xy * _tiling.xy;
    u_xlat2.xy = _Time.yy * vec2(_pannerspeed.x, _pannerspeed.y) + u_xlat2.xy;
    u_xlat16_2.xyz = texture(_T_VFX_Shared_RenderClouds_Minimize, u_xlat2.xy).xyz;
    u_xlat2.xyz = u_xlat16_2.xyz + vec3(vec3(_add, _add, _add));
    u_xlat2.xyz = vs_TEXCOORD1.yyy * u_xlat2.xyz + (-vs_TEXCOORD0.zzz);
    ...
    u_xlat12.xyz = u_xlat2.xyz * u_xlat4.xyz;
    u_xlat12.xyz = log2(u_xlat12.xyz);
    u_xlat12.xyz = u_xlat12.xyz * vec3(vec3(_EdgePower, _EdgePower, _EdgePower));
    u_xlat12.xyz = exp2(u_xlat12.xyz);
    u_xlat12.xyz = min(u_xlat12.xyz, vec3(1.0, 1.0, 1.0));
    u_xlat12.xyz = u_xlat12.xyz * _EdgeColor.xyz;
    u_xlat12.xyz = u_xlat12.xyz * vec3(_EdgeColorBrightness);
    u_xlat3.xyz = vs_COLOR0.xyz * vec3(_undercolorbrightness) + u_xlat12.xyz;
    u_xlat31 = dot(u_xlat12.xyz, vec3(0.298999995, 0.587000012, 0.114));
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat16_5.x = dot((-u_xlat1.xyz), vs_TEXCOORD2.xyz);
    u_xlat16_5.x = u_xlat16_5.x + u_xlat16_5.x;
    u_xlat16_5.xyz = vs_TEXCOORD2.xyz * (-u_xlat16_5.xxx) + (-u_xlat1.xyz);
#ifdef UNITY_ADRENO_ES3
    ...
    if(u_xlatb2){
        ...
        u_xlat2.xyz = u_xlat2.xyz * vec3(u_xlat32) + u_xlat4.xyz;
    } else {
    ...
    if(u_xlatb32){
        ...
        if(u_xlatb32){
            ...
            u_xlat4.xyz = vec3(u_xlat32) * u_xlat16_5.xyz;
        ...
        u_xlat2.xyz = vec3(u_xlat16_35) * u_xlat16_2.xyz + (-u_xlat16_5.xyz);
        u_xlat8.xyz = unity_SpecCube0_BoxMin.www * u_xlat2.xyz + u_xlat16_5.xyz;
    ...
    u_xlat16_15.xyz = u_xlat16_8.xyz * vec3(0.5, 0.5, 0.5);
    ...
    u_xlat0.xyz = u_xlat1.xyz * u_xlat16_5.xxx + u_xlat16_15.xyz;
