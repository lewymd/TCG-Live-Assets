...
//
///////////////////////////////////////////
Shader "TPCi/Boards_Grass_Border_Glows" {
Properties {
_LightShaftTexture ("Light Shaft Texture", 2D) = "white" { }
_LightShaft1Offset ("Light Shaft 1 Offset", Vector) = (0,0.09,0,0)
_LightShaft2Panning ("Light Shaft 2 Panning", Vector) = (0.8,0,0,0)
_LightShaft1Panning ("Light Shaft 1 Panning", Vector) = (-0.5,0,0,0)
_LightShaft2Tiling ("Light Shaft 2 Tiling", Vector) = (5,1,0,0)
_LightShaft1Tiling ("Light Shaft 1 Tiling", Vector) = (3,1,0,0)
_tex4coord ("", 2D) = "white" { }
_texcoord ("", 2D) = "white" { }
__dirty ("", Float) = 1
}
...
uniform 	vec2 _LightShaft1Panning;
uniform 	vec2 _LightShaft1Tiling;
uniform 	vec2 _LightShaft1Offset;
uniform 	vec2 _LightShaft2Panning;
uniform 	vec2 _LightShaft2Tiling;
UNITY_LOCATION(0) uniform mediump sampler2D _LightShaftTexture;
...
void main()
{
    ...
    u_xlat31 = (-vs_TEXCOORD1.y) + 1.0;
    u_xlat2.xyz = vec3(u_xlat31) * vs_COLOR0.xyz;
    u_xlat3.xy = vs_TEXCOORD1.xy * vec2(_LightShaft1Tiling.x, _LightShaft1Tiling.y) + _LightShaft1Offset.xy;
    u_xlat3.xy = _Time.yy * _LightShaft1Panning.xy + u_xlat3.xy;
    u_xlat23.xy = vs_TEXCOORD1.xy * _LightShaft2Tiling.xy + vec2(0.0, 0.0900000036);
    u_xlat23.xy = _Time.yy * vec2(_LightShaft2Panning.x, _LightShaft2Panning.y) + u_xlat23.xy;
    u_xlat16_32 = texture(_LightShaftTexture, u_xlat23.xy).x;
    u_xlat31 = log2(u_xlat31);
    u_xlat31 = u_xlat31 * 2.08999991;
    u_xlat31 = exp2(u_xlat31);
    u_xlat16_3.x = texture(_LightShaftTexture, u_xlat3.xy).x;
    u_xlat3.x = u_xlat16_3.x + 0.300000012;
    u_xlat32 = dot(u_xlat3.xx, vec2(u_xlat16_32));
    u_xlat31 = u_xlat31 * 0.349999994 + u_xlat32;
    u_xlat31 = log2(u_xlat31);
    u_xlat31 = u_xlat31 * vs_TEXCOORD0.w;
    u_xlat31 = exp2(u_xlat31);
    ...
    SV_Target0.xyz = vs_TEXCOORD0.zzz * u_xlat2.xyz + u_xlat0.xyz;
