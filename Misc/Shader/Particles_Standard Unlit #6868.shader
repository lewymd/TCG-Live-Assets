...
SubProgram "gles3 " {
Keywords { "SHADOWS_CUBE" }
Local Keywords { "_ALPHABLEND_ON" "_COLOROVERLAY_ON" "_REQUIRE_UV2" }
"#ifdef VERTEX
#version 300 es
...
void main()
{
    ...
    u_xlat16_16 = u_xlat16_11 * 6.0 + 1.00000001e-10;
    u_xlat16_6.x = u_xlat16_6.x / u_xlat16_16;
    u_xlat16_6.x = u_xlat16_6.x + u_xlat16_3.z;
    u_xlat16_16 = u_xlat16_3.x + 1.00000001e-10;
...
void main()
{
    ...
    u_xlat16_3.xyz = u_xlat16_3.xyz + vec3(-1.0, -1.0, -1.0);
    u_xlat16_6.xyz = vec3(u_xlat16_11) * u_xlat16_3.xyz + vec3(1.0, 1.0, 1.0);
    u_xlat16_4.xyz = texture(_EmissionMap, vs_TEXCOORD1.xy).xyz;
    u_xlat16_3.xyz = u_xlat16_4.xyz * vec3(_EmissionColor.x, _EmissionColor.y, _EmissionColor.z);
    u_xlat4.xyz = u_xlat16_1.xxx * u_xlat16_6.xyz + u_xlat16_3.xyz;
...
void main()
{
    ...
    u_xlat1.xyz = (-u_xlat16_2.xyz) * u_xlat1.xyz + vec3(1.0, 1.0, 1.0);
    u_xlat16_2.xyz = u_xlat16_0.xyz + u_xlat16_0.xyz;
    u_xlat3.xyz = u_xlat16_2.xyz * vs_COLOR0.xyz + (-u_xlat1.xyz);
    ...
    u_xlat0.xyz = u_xlat16_2.xyz * u_xlat3.xyz + u_xlat1.xyz;
    SV_Target0 = u_xlat0;
    return;
}
...
SubProgram "gles3 " {
Keywords { "_EMISSION" }
Local Keywords { "_ALPHABLEND_ON" "_COLORCOLOR_ON" "_FADING_ON" }
"#ifdef VERTEX
#version 300 es
...
void main()
{
    ...
    u_xlat16_2.x = u_xlat16_15 * 6.0 + 1.00000001e-10;
    ...
    u_xlatb3 = u_xlat16_2.y>=u_xlat16_2.z;
#endif
    u_xlat16_15 = (u_xlatb3) ? 1.0 : 0.0;
    u_xlat16_7 = u_xlat16_1.y * _Color.y + (-u_xlat16_2.z);
    u_xlat16_15 = u_xlat16_15 * u_xlat16_7 + u_xlat16_2.z;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat16_2.x = (u_xlatb3) ? 1.0 : 0.0;
    u_xlat16_7 = u_xlat16_1.x * _Color.x + (-u_xlat16_15);
    u_xlat16_15 = u_xlat16_2.x * u_xlat16_7 + u_xlat16_15;
    u_xlat16_3.xzw = texture(_EmissionMap, vs_TEXCOORD1.xy).xyz;
    u_xlat16_2.xyz = u_xlat16_3.xzw * vec3(_EmissionColor.x, _EmissionColor.y, _EmissionColor.z);
...
#endif
    u_xlat4.xyz = u_xlat16_2.xyz * vec3(u_xlat3);
    u_xlat1.w = u_xlat3 * u_xlat8;
    u_xlat1.xyz = vec3(u_xlat16_15) * u_xlat16_0.xyz + u_xlat4.xyz;
    SV_Target0 = u_xlat1;
    return;
}
...
SubProgram "gles3 " {
Local Keywords { "_ALPHABLEND_ON" "_COLOROVERLAY_ON" "_FADING_ON" "_REQUIRE_UV2" }
"#ifdef VERTEX
#version 300 es
...
void main()
{
    ...
    u_xlat3.xyz = u_xlat16_2.xyz * vs_COLOR0.xyz + (-u_xlat1.xyz);
    u_xlatb4.xyz = greaterThanEqual(vec4(0.5, 0.5, 0.5, 0.0), u_xlat16_0.xyzx).xyz;
    u_xlat16 = u_xlat16_0.w * vs_COLOR0.w;
    u_xlat16_2.x = (u_xlatb4.x) ? float(1.0) : float(0.0);
    u_xlat16_2.y = (u_xlatb4.y) ? float(1.0) : float(0.0);
    u_xlat16_2.z = (u_xlatb4.z) ? float(1.0) : float(0.0);
    u_xlat0.xyz = u_xlat16_2.xyz * u_xlat3.xyz + u_xlat1.xyz;
