...
//
///////////////////////////////////////////
Shader "TPCi/VFX/Particles/Particle_Simple_Alpha_Dissolve_Pan" {
Properties {
...
void main()
{
    ...
    u_xlat4.xy = _Time.yy * _PanSpeed.xy;
    u_xlat0.xy = u_xlat4.xy * vec2(0.76171875, 0.76171875) + u_xlat0.xy;
...
#endif
    u_xlat2.x = max(vs_TEXCOORD0.z, -1.0);
    u_xlat2.x = min(u_xlat2.x, 1.0);
    u_xlat0.x = (-u_xlat2.x) + u_xlat0.x;
    u_xlat4.x = u_xlat2.x + _SmoothstepMax;
#ifdef UNITY_ADRENO_ES3
