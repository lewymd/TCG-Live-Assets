...
//
///////////////////////////////////////////
Shader "TPCi/VFX/Particles/Particle_PreMult_Alpha_Dissolve" {
Properties {
...
void main()
{
    ...
    u_xlat2.x = u_xlat0.x + _SmoothstepMax;
    ...
    u_xlat4.xy = vs_TEXCOORD0.xy * _DissolveTexture_ST.xy + _DissolveTexture_ST.zw;
    u_xlat16_4 = texture(_DissolveTexture, u_xlat4.xy).x;
    u_xlat4.x = u_xlat16_4 * _DissolveIntensity;
#ifdef UNITY_ADRENO_ES3
    ...
    u_xlat4.x = (-u_xlat16_2.x) + u_xlat16_2.y;
    u_xlat2.x = _AlphaChannel * u_xlat4.x + u_xlat16_2.x;
