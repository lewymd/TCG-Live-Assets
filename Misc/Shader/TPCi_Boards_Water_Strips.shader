...
//
///////////////////////////////////////////
Shader "TPCi/Boards_Water_Strips" {
Properties {
_T_VFX_Water_Splash_Strip_1 ("T_VFX_Water_Splash_Strip_1", 2D) = "white" { }
_Texture1Offset ("Texture 1 Offset", Vector) = (0,-0.02,0,0)
[Toggle(_CONTROLPARTICLE_ON)] _controlparticle ("control particle", Float) = 0
_tex4coord ("", 2D) = "white" { }
_texcoord ("", 2D) = "white" { }
__dirty ("", Float) = 1
}
...
uniform 	vec2 _Texture1Offset;
UNITY_LOCATION(0) uniform mediump sampler2D _T_VFX_Water_Splash_Strip_1;
...
void main()
{
    ...
    u_xlat2.xy = vs_TEXCOORD0.xy + _Texture1Offset.xy;
    u_xlat16_2 = texture(_T_VFX_Water_Splash_Strip_1, u_xlat2.xy);
...
#endif
    if(u_xlatb32){
        u_xlat32 = dot(u_xlat16_3.xyz, u_xlat16_3.xyz);
        u_xlat32 = inversesqrt(u_xlat32);
        u_xlat4.xyz = vec3(u_xlat32) * u_xlat16_3.xyz;
    ...
    if(u_xlatb32){
        ...
        if(u_xlatb32){
            u_xlat32 = dot(u_xlat16_3.xyz, u_xlat16_3.xyz);
            u_xlat32 = inversesqrt(u_xlat32);
            u_xlat5.xyz = vec3(u_xlat32) * u_xlat16_3.xyz;
    ...
    u_xlat16_13.xyz = u_xlat16_8.xyz * vec3(0.5, 0.5, 0.5);
    ...
    u_xlat16_13.xyz = u_xlat16_13.xyz * u_xlat16_8.xxx;
    u_xlat0.xyz = u_xlat1.xyz * u_xlat16_3.xxx + u_xlat16_13.xyz;
...
SubProgram "gles3 " {
Keywords { "DIRECTIONAL" "LIGHTPROBE_SH" "_CONTROLPARTICLE_ON" }
"#ifdef VERTEX
#version 300 es
...
void main()
{
    ...
    u_xlat30 = inversesqrt(u_xlat30);
    u_xlat1.xyz = vec3(u_xlat30) * u_xlat0.xyz;
    u_xlat2.x = vs_TEXCOORD1.x + _Texture1Offset.x;
    u_xlat2.y = _Texture1Offset.y * vs_TEXCOORD0.z + vs_TEXCOORD1.y;
    u_xlat16_2 = texture(_T_VFX_Water_Splash_Strip_1, u_xlat2.xy);
    u_xlat31 = u_xlat16_2.w * vs_COLOR0.w;
    ...
    u_xlat32 = inversesqrt(u_xlat32);
    u_xlat4.xyz = vec3(u_xlat32) * vs_TEXCOORD2.xyz;
    u_xlat0.xyz = u_xlat0.xyz * vec3(u_xlat30) + _WorldSpaceLightPos0.xyz;
    u_xlat30 = dot(u_xlat0.xyz, u_xlat0.xyz);
    u_xlat30 = max(u_xlat30, 0.00100000005);
    u_xlat30 = inversesqrt(u_xlat30);
...
SubProgram "gles3 " {
Keywords { "DIRECTIONAL" "_CONTROLPARTICLE_ON" }
"#ifdef VERTEX
#version 300 es
