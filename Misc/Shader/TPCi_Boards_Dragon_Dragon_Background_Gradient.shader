...
//
///////////////////////////////////////////
Shader "TPCi/Boards/Dragon/Dragon_Background_Gradient" {
Properties {
_GradientOffset ("Gradient Offset", Vector) = (0,0,0,0)
_GradientMin ("Gradient Min", Float) = 0
_GradientMax ("Gradient Max", Float) = 1
_Color1 ("Color 1", Color) = (0.5849056,0.2301891,0,0)
_Color2 ("Color 2", Color) = (0.8018868,0.3445143,0,0)
...
void main()
{
    u_xlat0.x = vs_TEXCOORD0.y + _GradientOffset.xxxy.w;
    u_xlat0.x = u_xlat0.x + (-_GradientMin);
    u_xlat1.x = float(1.0) / _GradientMax;
