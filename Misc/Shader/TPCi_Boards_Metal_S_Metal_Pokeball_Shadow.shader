...
//
///////////////////////////////////////////
Shader "TPCi/Boards/Metal/S_Metal_Pokeball_Shadow" {
Properties {
_ShadowOpacity ("Shadow Opacity", Float) = 1
__dirty ("", Float) = 1
}
SubShader {
...
void main()
{
    ...
    vs_TEXCOORD2.xyz = u_xlat16_2.xyz + u_xlat16_3.xyz;
    vs_TEXCOORD5 = vec4(0.0, 0.0, 0.0, 0.0);
    return;
}
