...
//
///////////////////////////////////////////
Shader "TPCi/Boards/Metal/Metal_Sheen_Wipe" {
Properties {
_T_VFX_Metal_Sheen_Wipe ("T_VFX_Metal_Sheen_Wipe", 2D) = "white" { }
_tex4coord ("", 2D) = "white" { }
_texcoord ("", 2D) = "white" { }
__dirty ("", Float) = 1
}
...
#define UNITY_BINDING(x) layout(std140)
#endif
UNITY_LOCATION(0) uniform mediump sampler2D _T_VFX_Metal_Sheen_Wipe;
...
void main()
{
    ...
    u_xlat16_0 = texture(_T_VFX_Metal_Sheen_Wipe, u_xlat0.xy).x;
