...
//
///////////////////////////////////////////
Shader "TPCi/VFX/Particles/Particle_Master_Edit_Deprecated" {
Properties {
...
void main()
{
    ...
    u_xlat9 = max(_EmissiveProperties, 1.0);
    u_xlat9 = min(u_xlat9, 100000.0);
    u_xlat2.xyz = vec3(u_xlat9) * u_xlat16_0.xyz;
    u_xlat10 = dot(u_xlat2.xyz, vec3(0.298999995, 0.587000012, 0.114));
    u_xlat0.xyz = (-u_xlat16_0.xyz) * vec3(u_xlat9) + vec3(u_xlat10);
    u_xlat0.xyz = vec3(vec3(_TextureDesaturation, _TextureDesaturation, _TextureDesaturation)) * u_xlat0.xyz + u_xlat2.xyz;
