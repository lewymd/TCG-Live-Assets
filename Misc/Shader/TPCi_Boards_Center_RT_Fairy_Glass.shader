...
//
///////////////////////////////////////////
Shader "TPCi/Boards/Center_RT_Fairy_Glass" {
Properties {
...
void main()
{
    ...
    u_xlat16_0 = texture(_T_VFX_Gradient_Beam_Horizontal, u_xlat0.xy).x;
    u_xlat0.x = log2(u_xlat16_0);
    u_xlat0.x = u_xlat0.x * _Power;
    u_xlat0.x = exp2(u_xlat0.x);
    u_xlat0.w = min(u_xlat0.x, 1.0);
    u_xlat0.xyz = vec3(_Emissive) * _Color.xyz;
    SV_Target0 = u_xlat0;
    return;
}
