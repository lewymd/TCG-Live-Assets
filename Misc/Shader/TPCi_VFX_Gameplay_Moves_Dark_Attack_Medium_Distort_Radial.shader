...
//
///////////////////////////////////////////
Shader "TPCi/VFX/Gameplay/Moves/Dark_Attack_Medium_Distort_Radial" {
Properties {
...
void main()
{
    ...
    u_xlat1.x = vs_TEXCOORD1.z * _Brightness;
    u_xlat2.xyz = u_xlat2.xyz * u_xlat1.xxx;
    u_xlat2.xyz = max(u_xlat2.xyz, vec3(0.0, 0.0, 0.0));
    u_xlat1.xyz = min(u_xlat2.xyz, vec3(1000.0, 1000.0, 1000.0));
    ...
    u_xlat0.x = u_xlat0.x * _AlphaMultiply;
