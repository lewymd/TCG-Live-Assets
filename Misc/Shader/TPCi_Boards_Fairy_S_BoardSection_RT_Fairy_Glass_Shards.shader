...
//
///////////////////////////////////////////
Shader "TPCi/Boards/Fairy/S_BoardSection_RT_Fairy_Glass_Shards" {
Properties {
...
void main()
{
    ...
    u_xlat4.xy = vs_TEXCOORD0.xy * vec2(1.0, 0.25);
    u_xlat4.xy = _Time.yy * vec2(0.0, -2.0) + u_xlat4.xy;
    u_xlat16_1.xyz = texture(_TextureSample0, u_xlat4.xy).xyz;
    u_xlat0.xyz = u_xlat0.xxx * vec3(u_xlat2) + u_xlat16_1.xyz;
    ...
    u_xlat0.xyz = u_xlat0.wxy * vs_COLOR0.xyz;
    SV_Target0 = u_xlat0;
    return;
}
...
void main()
{
    ...
    u_xlat2.xy = vs_TEXCOORD0.xy * vec2(1.0, 0.25);
    u_xlat2.xy = _Time.yy * vec2(0.0, -2.0) + u_xlat2.xy;
    u_xlat16_2 = texture(_TextureSample0, u_xlat2.xy).x;
    u_xlat0.x = u_xlat0.x * u_xlat1 + u_xlat16_2;
