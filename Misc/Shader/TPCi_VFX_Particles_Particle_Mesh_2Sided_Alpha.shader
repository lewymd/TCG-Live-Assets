...
//
///////////////////////////////////////////
Shader "TPCi/VFX/Particles/Particle_Mesh_2Sided_Alpha" {
Properties {
...
uniform 	vec4 _ParticleTexture_ST;
uniform 	vec4 _ParticleAlpha_ST;
uniform 	float _AlphaChannel;
uniform 	float _Alpha_Intensity;
uniform 	float _Cutoff;
UNITY_LOCATION(0) uniform mediump sampler2D _ParticleTexture;
...
#endif
    if(u_xlatb0){discard;}
    u_xlat0.xy = vs_TEXCOORD0.xy * _ParticleTexture_ST.xy + _ParticleTexture_ST.zw;
    u_xlat16_0.xyz = texture(_ParticleTexture, u_xlat0.xy).xyz;
...
void main()
{
    u_xlat0.xy = vs_TEXCOORD0.xy * _ParticleAlpha_ST.xy + _ParticleAlpha_ST.zw;
    u_xlat16_0.xy = texture(_ParticleAlpha, u_xlat0.xy).xw;
    u_xlat1 = (-u_xlat16_0.x) + u_xlat16_0.y;
    u_xlat0.x = _AlphaChannel * u_xlat1 + u_xlat16_0.x;
    u_xlat0.x = u_xlat0.x * _Alpha_Intensity;
#ifdef UNITY_ADRENO_ES3
    u_xlat0.x = min(max(u_xlat0.x, 0.0), 1.0);
#else
