...
//
///////////////////////////////////////////
Shader "TPCi/VFX/Gameplay/Evolution/Evolution_Lotus_Mesh" {
Properties {
_T_VFX_LightShaft ("T_VFX_LightShaft", 2D) = "white" { }
_EmissiveAmount ("Emissive Amount", Float) = 2
...
_panningspeed ("panning speed", Vector) = (0,1,0,0)
_BlueScaleAmount ("Blue Scale Amount", Float) = 3
_smoothstepmin ("smoothstep min", Float) = 0
_smoothstepmax ("smoothstep max", Float) = 1
_tex4coord2 ("", 2D) = "white" { }
_texcoord ("", 2D) = "white" { }
__dirty ("", Float) = 1
}
SubShader {
...
void main()
{
    ...
    vs_TEXCOORD0.xy = in_TEXCOORD1.xy * _tex4coord2_ST.xy + _tex4coord2_ST.zw;
...
uniform 	vec2 _panningspeed;
uniform 	vec2 _tiling;
uniform 	float _BlueScaleAmount;
...
#endif
    u_xlat4.xyz = (-_EmissiveColorEnd.xyz) + _EmissiveColorBeginning.xyz;
    u_xlat0.xyz = u_xlat0.xxx * u_xlat4.xyz + _EmissiveColorEnd.xyz;
    u_xlat12 = (-_smoothstepmin) + _smoothstepmax;
    u_xlat12 = float(1.0) / u_xlat12;
    u_xlat1.x = vs_COLOR0.z * _BlueScaleAmount + _tiling.y;
    u_xlat1.y = u_xlat1.x * vs_TEXCOORD1.y;
    u_xlat1.x = vs_TEXCOORD1.x * _tiling.x;
    u_xlat1.xy = _Time.yy * vec2(_panningspeed.x, _panningspeed.y) + u_xlat1.xy;
    u_xlat16_1.xyz = texture(_T_VFX_LightShaft, u_xlat1.xy).xyz;
    u_xlat2.xyz = u_xlat16_1.xyz + (-vec3(_smoothstepmin));
...
#endif
    u_xlat12 = vs_TEXCOORD0.y * _EmissiveAmount;
