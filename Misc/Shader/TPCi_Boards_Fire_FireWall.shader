...
//
///////////////////////////////////////////
Shader "TPCi/Boards_Fire_FireWall" {
Properties {
...
_FireTravel ("Fire Travel", Float) = 0.28
...
[Toggle(_CONTROLSMOOTHSTEPBYCURVE_ON)] _ControlSmoothstepByCurve ("Control Smoothstep By Curve?", Float) = 0
[Toggle(_FIRETRAVELSBYCURVE_ON)] _FireTravelsbyCurve ("Fire Travels by Curve", Float) = 0
_tex4coord ("", 2D) = "white" { }
_texcoord ("", 2D) = "white" { }
__dirty ("", Float) = 1
}
...
void main()
{
    ...
    u_xlat2.xyz = vec3(u_xlat31) * u_xlat2.xyz + _ExteriorfireColor1.xyz;
    u_xlat3.xyz = vs_COLOR0.xyz * vec3(vec3(_vertexcolormultiplier, _vertexcolormultiplier, _vertexcolormultiplier));
#ifdef UNITY_ADRENO_ES3
    u_xlat3.xyz = min(max(u_xlat3.xyz, 0.0), 1.0);
#else
    u_xlat3.xyz = clamp(u_xlat3.xyz, 0.0, 1.0);
#endif
    u_xlat4.xy = vs_TEXCOORD0.xy * vec2(_cloudstiling.x, _cloudstiling.y);
    u_xlat4.xy = _Time.yy * _cloudspanning.xy + u_xlat4.xy;
    u_xlat24.xy = vs_TEXCOORD0.xy * vec2(_clouds2tiling.x, _clouds2tiling.y);
    u_xlat24.xy = _Time.yy * _clouds2panning.xy + u_xlat24.xy;
    u_xlat16_5.xyz = texture(_T_VFX_Shared_RenderClouds_Minimize_2, u_xlat4.xy).xyz;
    u_xlat16_4.xyz = texture(_TextureSample0, u_xlat24.xy).xyz;
    u_xlat4.xyz = u_xlat16_5.xyz * u_xlat16_4.xyz + vec3(_cloudsadd);
    u_xlat3.xyz = u_xlat3.xyz * u_xlat4.xyz;
    u_xlat13.xyz = log2(u_xlat3.xyz);
    u_xlat13.xyz = u_xlat13.xyz * vec3(vec3(_colorlerppower, _colorlerppower, _colorlerppower));
    u_xlat13.xyz = exp2(u_xlat13.xyz);
    u_xlat13.xyz = u_xlat13.xyz * vec3(vec3(_colorlerpmult, _colorlerpmult, _colorlerpmult)) + (-vec3(_colorlerpsmoothstepmin));
...
#endif
    u_xlat4.xyz = u_xlat13.xyz * vec3(-2.0, -2.0, -2.0) + vec3(3.0, 3.0, 3.0);
    ...
    u_xlat4.xyz = (-u_xlat2.xyz) + _InteriorFireColor.xyz;
    u_xlat2.xyz = u_xlat13.xyz * u_xlat4.xyz + u_xlat2.xyz;
    u_xlat31 = _FireTravel * 15.0;
    u_xlat32 = log2(vs_TEXCOORD0.y);
    u_xlat31 = u_xlat31 * u_xlat31;
    u_xlat31 = u_xlat31 * u_xlat32;
    u_xlat31 = exp2(u_xlat31);
    u_xlat31 = (-u_xlat31) * 2.0 + 1.0;
    u_xlat32 = u_xlat31 * 5.0;
#ifdef UNITY_ADRENO_ES3
    u_xlat32 = min(max(u_xlat32, 0.0), 1.0);
#else
    u_xlat32 = clamp(u_xlat32, 0.0, 1.0);
#endif
    u_xlat13.x = u_xlat32 * -2.0 + 3.0;
    ...
    u_xlat31 = (-u_xlat31) + u_xlat32;
    u_xlat31 = u_xlat31 * u_xlat31;
    u_xlat31 = u_xlat31 * _emissiveedgefollowintensity;
    u_xlat13.xyz = vec3(u_xlat31) * _FireEdgeTravelColor.xyz;
    u_xlat2.xyz = u_xlat2.xyz * vec3(vec3(_emissivebrightness, _emissivebrightness, _emissivebrightness)) + u_xlat13.xyz;
    u_xlat31 = u_xlat3.x * u_xlat32 + (-_smoothstepmin);
...
Local Keywords { "_CONTROLSMOOTHSTEPBYCURVE_ON" "_FIRETRAVELSBYCURVE_ON" }
"#ifdef VERTEX
#version 300 es
...
void main()
{
    ...
    u_xlat13.xyz = vec3(u_xlat31) * _FireEdgeTravelColor.xyz;
    u_xlat2.xyz = u_xlat2.xyz * vec3(vec3(_emissivebrightness, _emissivebrightness, _emissivebrightness)) + u_xlat13.xyz;
    u_xlat31 = vs_TEXCOORD1.z * _smoothstepmin;
