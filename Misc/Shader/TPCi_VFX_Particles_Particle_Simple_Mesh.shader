...
//
///////////////////////////////////////////
Shader "TPCi/VFX/Particles/Particle_Simple_Mesh" {
Properties {
_Color ("Color", Color) = (0.5019608,0.5019608,0.5019608,0)
_AddWhiteOpacity ("AddWhiteOpacity", Range(0, 1)) = 0
...
void main()
{
    ...
    u_xlat3.xyz = vs_COLOR0.xyz * _Color.xyz;
    ...
    if(u_xlatb34){
        ...
        u_xlat3.xyz = u_xlat3.xyz * vec3(u_xlat34) + u_xlat5.xyz;
    } else {
    ...
    u_xlat0.xyz = u_xlat11.xyz * vec3(u_xlat16_37);
...
void main()
{
    ...
    if(u_xlatb37){
        ...
        u_xlat3.xyz = vec3(u_xlat37) * u_xlat16_4.xyz;
    ...
    if(u_xlatb37){
        ...
        u_xlat3.xyz = vec3(u_xlat16_40) * u_xlat16_3.xyz + (-u_xlat16_4.xyz);
    ...
    u_xlat16_5.xyz = _LightColor0.xyz * u_xlat12.xxx + u_xlat16_5.xyz;
...
void main()
{
    ...
    u_xlat16_4.x = u_xlat38 * u_xlat16_4.x + _LightShadowData.x;
    u_xlat16_16.x = (-u_xlat16_4.x) + 1.0;
    u_xlat16_4.x = u_xlat37 * u_xlat16_16.x + u_xlat16_4.x;
    ...
    if(u_xlatb37){
        ...
        u_xlat3.xyz = u_xlat16_4.xxx * u_xlat16_3.xyz + (-u_xlat16_16.xyz);
...
void main()
{
    ...
    if(u_xlatb37){
        ...
        u_xlat3.xyz = u_xlat3.xyz * vec3(u_xlat37) + u_xlat7.xyz;
    } else {
        u_xlat3.xyz = u_xlat16_16.xyz;
    }
    u_xlat16_3 = textureLod(unity_SpecCube0, u_xlat3.xyz, 6.0);
    ...
    if(u_xlatb37){
        ...
        if(u_xlatb37){
            u_xlat37 = dot(u_xlat16_16.xyz, u_xlat16_16.xyz);
            u_xlat37 = inversesqrt(u_xlat37);
            u_xlat7.xyz = vec3(u_xlat37) * u_xlat16_16.xyz;
        ...
        u_xlat16_7 = textureLod(unity_SpecCube1, u_xlat7.xyz, 6.0);
        ...
        u_xlat3.xyz = u_xlat16_4.xxx * u_xlat16_3.xyz + (-u_xlat16_16.xyz);
        u_xlat10.xyz = unity_SpecCube0_BoxMin.www * u_xlat3.xyz + u_xlat16_16.xyz;
    ...
    u_xlat24 = u_xlat1.x * u_xlat24;
    u_xlat24 = u_xlat24 * 0.999999881;
    u_xlat16_6.xyz = u_xlat16_5.xyz * u_xlat12.xxx + u_xlat16_6.xyz;
    u_xlat12.xyz = u_xlat16_5.xyz * vec3(u_xlat24);
    u_xlat16_40 = (-u_xlat0.x) + 1.0;
    u_xlat16_5.x = u_xlat16_40 * u_xlat16_40;
    u_xlat16_5.x = u_xlat16_5.x * u_xlat16_5.x;
    ...
    u_xlat16_40 = u_xlat16_42 * 2.23517418e-08 + 0.0399999991;
    u_xlat0.xyz = u_xlat16_4.xyz * vec3(u_xlat16_40) + u_xlat0.xyz;
    SV_Target0.xyz = u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
...
void main()
{
    ...
    u_xlat16_8.z = (-u_xlat5) + 1.0;
    u_xlat16_4.xw = u_xlat16_8.zx * u_xlat16_8.zx;
    u_xlat16_4.xw = u_xlat16_4.xw * u_xlat16_4.xw;
    u_xlat16_8.xz = u_xlat16_8.xz * u_xlat16_4.wx;
    u_xlat16_3.x = u_xlat16_3.x * u_xlat16_8.z + 1.0;
    ...
    u_xlat16_3.xzw = u_xlat1.xyz * vec3(0.959999979, 0.959999979, 0.959999979);
    u_xlat16_8.x = u_xlat16_8.x * 0.959999979 + 0.0399999991;
    u_xlat0.xyz = u_xlat0.xyz * u_xlat16_8.xxx;
    u_xlat0.xyz = u_xlat16_3.xzw * u_xlat16_4.xyz + u_xlat0.xyz;
    SV_Target0.xyz = u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_13.y = (-u_xlat0.x) + 1.0;
    u_xlat16_4.xw = u_xlat16_13.yx * u_xlat16_13.yx;
    u_xlat16_4.xw = u_xlat16_4.xw * u_xlat16_4.xw;
    u_xlat16_13.xy = u_xlat16_13.xy * u_xlat16_4.wx;
    u_xlat16_8 = u_xlat16_8 * u_xlat16_13.y + 1.0;
    u_xlat16_3.x = u_xlat16_3.x * u_xlat16_8;
    ...
    u_xlat16_13.x = u_xlat16_13.x * 0.959999979 + 0.0399999991;
    u_xlat0.xyz = u_xlat5.xyz * u_xlat16_13.xxx;
...
void main()
{
    ...
    u_xlat2.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat1.xyz = u_xlat16_1.xyz * u_xlat2.xyz;
    u_xlat16_3.xyw = u_xlat1.xyz * vec3(0.959999979, 0.959999979, 0.959999979);
    u_xlat16_13.x = u_xlat16_13.x * 0.959999979 + 0.0399999991;
    u_xlat0.xyz = u_xlat0.xyz * u_xlat16_13.xxx;
    u_xlat0.xyz = u_xlat16_3.xyw * u_xlat16_4.xyz + u_xlat0.xyz;
    SV_Target0.xyz = u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_19 = u_xlat16_9.y * u_xlat16_9.y;
    u_xlat16_19 = u_xlat16_19 * u_xlat16_19;
    u_xlat16_14 = u_xlat16_9.y * u_xlat16_19;
    u_xlat16_4.x = u_xlat16_4.x * u_xlat16_14 + 1.0;
    u_xlat16_17 = u_xlat16_17 * u_xlat16_4.x;
    u_xlat0.x = u_xlat0.y * u_xlat16_17;
    u_xlat16_4.xzw = u_xlat0.xxx * u_xlat16_2.xyz;
    ...
    u_xlat16_2.x = u_xlat16_9.x * u_xlat16_9.x;
    ...
    u_xlat0.xyz = u_xlat16_2.xyz * u_xlat16_4.xzw + u_xlat0.xyz;
    SV_Target0.xyz = u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_17 = u_xlat16_17 * u_xlat16_17;
    u_xlat16_17 = u_xlat16_9.x * u_xlat16_17;
    u_xlat16_17 = u_xlat16_17 * 0.959999979 + 0.0399999991;
    u_xlat0.x = abs(u_xlat15) + u_xlat0.y;
    u_xlat0.x = u_xlat0.x + 9.99999975e-06;
    u_xlat0.x = 0.5 / u_xlat0.x;
...
void main()
{
    ...
    u_xlat16_4.x = u_xlat12 * u_xlat16_10 + u_xlat16_4.x;
...
void main()
{
    ...
    u_xlat5.x = clamp(u_xlat5.x, 0.0, 1.0);
#endif
    u_xlat16_1.x = u_xlat5.x * u_xlat16_6 + u_xlat16_1.x;
    ...
    u_xlat5.x = clamp(u_xlat5.x, 0.0, 1.0);
#endif
    u_xlat16_16 = -abs(u_xlat0.x) + 1.0;
    u_xlat0.x = abs(u_xlat0.x) + u_xlat5.x;
    u_xlat0.x = u_xlat0.x + 9.99999975e-06;
    u_xlat0.x = 0.5 / u_xlat0.x;
    ...
    u_xlat16_4.x = u_xlat16_4.x * u_xlat2.x + -0.5;
    u_xlat16_9 = (-u_xlat2.x) + 1.0;
    u_xlat16_16 = u_xlat16_4.x * u_xlat16_16 + 1.0;
    ...
    u_xlat16_4.x = u_xlat16_4.x * u_xlat16_14 + 1.0;
    u_xlat16_16 = u_xlat16_16 * u_xlat16_4.x;
    u_xlat5.x = u_xlat5.x * u_xlat16_16;
    u_xlat16_1.xyz = u_xlat5.xxx * u_xlat16_1.xyz;
    u_xlat16_16 = u_xlat16_9 * u_xlat16_9;
    u_xlat16_16 = u_xlat16_16 * u_xlat16_16;
    u_xlat16_16 = u_xlat16_9 * u_xlat16_16;
    u_xlat16_16 = u_xlat16_16 * 0.959999979 + 0.0399999991;
    u_xlat0.xyz = u_xlat0.xzw * vec3(u_xlat16_16);
    u_xlat2.xy = vs_TEXCOORD0.xy * _Albedo_ST.xy + _Albedo_ST.zw;
    u_xlat16_2.xyz = texture(_Albedo, u_xlat2.xy).xyz;
    u_xlat3.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat2.xyz = u_xlat16_2.xyz * u_xlat3.xyz;
...
void main()
{
    ...
    u_xlat17 = inversesqrt(u_xlat17);
    u_xlat0.xyz = u_xlat4.xyz * vec3(u_xlat17) + u_xlat0.xyz;
    ...
    u_xlat16_16 = u_xlat16_16 * u_xlat16_3.x;
    u_xlat0.x = u_xlat0.y * u_xlat16_16;
    u_xlat16_3.xzw = u_xlat0.xxx * u_xlat16_1.xyz;
    u_xlat0.x = abs(u_xlat15) + u_xlat0.y;
    u_xlat0.x = u_xlat0.x + 9.99999975e-06;
    u_xlat0.x = 0.5 / u_xlat0.x;
    u_xlat0.x = u_xlat0.y * u_xlat0.x;
    ...
    u_xlat2.xy = vs_TEXCOORD0.xy * _Albedo_ST.xy + _Albedo_ST.zw;
    u_xlat16_2.xyz = texture(_Albedo, u_xlat2.xy).xyz;
    u_xlat4.xyz = vs_COLOR0.xyz * _Color.xyz;
    u_xlat2.xyz = u_xlat16_2.xyz * u_xlat4.xyz;
    u_xlat16_1.xyz = u_xlat2.xyz * vec3(0.959999979, 0.959999979, 0.959999979);
    u_xlat0.xyz = u_xlat16_1.xyz * u_xlat16_3.xzw + u_xlat0.xyz;
    SV_Target0.xyz = u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
...
void main()
{
    ...
    u_xlat16_4.x = u_xlat16_4.x * u_xlat16_14 + 1.0;
    u_xlat16_18 = u_xlat16_18 * u_xlat16_4.x;
    u_xlat0.x = u_xlat0.y * u_xlat16_18;
    u_xlat16_4.xzw = u_xlat0.xxx * u_xlat16_3.xyz;
    u_xlat0.x = abs(u_xlat15) + u_xlat0.y;
    u_xlat0.x = u_xlat0.x + 9.99999975e-06;
    u_xlat0.x = 0.5 / u_xlat0.x;
    u_xlat0.x = u_xlat0.y * u_xlat0.x;
    ...
    u_xlat0.xyz = u_xlat16_3.xyz * u_xlat16_4.xzw + u_xlat0.xyz;
    SV_Target0.xyz = u_xlat0.xyz;
    SV_Target0.w = 1.0;
    return;
}
