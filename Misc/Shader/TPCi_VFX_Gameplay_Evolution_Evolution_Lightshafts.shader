...
//
///////////////////////////////////////////
Shader "TPCi/VFX/Gameplay/Evolution/Evolution_Lightshafts" {
Properties {
...
void main()
{
    u_xlat0.x = vs_TEXCOORD1.z * _Opacity;
    u_xlat0.x = u_xlat0.x * vs_COLOR0.w;
    u_xlat3.xy = vs_TEXCOORD0.xy * _T_VFX_Evolution_LightRay_ST.xy + _T_VFX_Evolution_LightRay_ST.zw;
    u_xlat16_3.xyz = texture(_T_VFX_Evolution_LightRay, u_xlat3.xy).xyz;
    ...
    u_xlat1.xyz = u_xlat1.xxx * u_xlat4.xyz + _EmissiveColorEnd.xyz;
