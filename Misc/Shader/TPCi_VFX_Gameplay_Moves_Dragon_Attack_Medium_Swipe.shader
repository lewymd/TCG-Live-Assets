...
//
///////////////////////////////////////////
Shader "TPCi/VFX/Gameplay/Moves/Dragon_Attack_Medium_Swipe" {
Properties {
_TextureSample0 ("Texture Sample 0", 2D) = "white" { }
_TextureSample1 ("Texture Sample 1", 2D) = "white" { }
_Alphamultiply ("Alpha multiply", Float) = 1
_EmissiveAmount ("Emissive Amount", Float) = 1
_OffsetScratch ("Offset Scratch", Float) = 1
_tex4coord ("", 2D) = "white" { }
_texcoord ("", 2D) = "white" { }
__dirty ("", Float) = 1
}
...
{
    u_xlat0.z = 0.0;
    u_xlat0.xy = vs_TEXCOORD0.wz * vec2(_OffsetScratch, _EmissiveAmount);
    u_xlat0.xz = u_xlat0.zx + vs_TEXCOORD1.xy;
    u_xlat16_1 = texture(_TextureSample0, u_xlat0.xz);
    u_xlat0.xyz = u_xlat0.yyy * u_xlat16_1.xyz;
#ifdef UNITY_ADRENO_ES3
    u_xlat0.xyz = min(max(u_xlat0.xyz, 0.0), 1.0);
#else
    u_xlat0.xyz = clamp(u_xlat0.xyz, 0.0, 1.0);
#endif
    u_xlat1 = u_xlat16_1.w * _Alphamultiply;
#ifdef UNITY_ADRENO_ES3
    u_xlat1 = min(max(u_xlat1, 0.0), 1.0);
#else
    u_xlat1 = clamp(u_xlat1, 0.0, 1.0);
#endif
    u_xlat3.xy = vs_TEXCOORD1.xy * _TextureSample1_ST.xy + _TextureSample1_ST.zw;
    u_xlat16_3 = texture(_TextureSample1, u_xlat3.xy).x;
    u_xlat0.w = u_xlat16_3 * u_xlat1;
    SV_Target0 = u_xlat0;
    return;
}
