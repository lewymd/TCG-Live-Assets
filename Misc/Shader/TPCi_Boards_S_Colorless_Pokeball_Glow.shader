...
//
///////////////////////////////////////////
Shader "TPCi/Boards/S_Colorless_Pokeball_Glow" {
Properties {
_TextureSample0 ("Texture Sample 0", 2D) = "white" { }
_T_VFX_Colorless_ColorRamp_1 ("T_VFX_Colorless_ColorRamp_1", 2D) = "white" { }
_PannerOverTime ("Panner Over Time", Range(0, 5)) = 0.25
_texcoord ("", 2D) = "white" { }
__dirty ("", Float) = 1
}
SubShader {
...
#endif
uniform 	vec4 _Time;
uniform 	float _PannerOverTime;
UNITY_LOCATION(0) uniform mediump sampler2D _TextureSample0;
UNITY_LOCATION(1) uniform mediump sampler2D _T_VFX_Colorless_ColorRamp_1;
...
void main()
{
    u_xlat0.xy = vs_TEXCOORD0.xy * vec2(3.0, 0.100000001);
    u_xlat0.xy = vec2(_PannerOverTime) * vec2(0.0, -0.100000001) + u_xlat0.xy;
    u_xlat16_0 = texture(_TextureSample0, u_xlat0.xy).x;
    u_xlat2 = (-vs_TEXCOORD0.y) + 1.0;
    u_xlat4 = log2(u_xlat2);
    u_xlat4 = u_xlat4 * 20.6100006;
    u_xlat4 = exp2(u_xlat4);
    u_xlat4 = min(u_xlat4, 1.0);
    u_xlat4 = u_xlat2 * u_xlat16_0 + u_xlat4;
    ...
    u_xlat0.xy = _Time.yy * vec2(0.100000001, 0.0) + u_xlat0.xx;
    u_xlat1.xyz = texture(_T_VFX_Colorless_ColorRamp_1, u_xlat0.xy).xyz;
...
void main()
{
    ...
    u_xlat2 = u_xlat2 * 20.6100006;
    u_xlat2 = exp2(u_xlat2);
    u_xlat2 = min(u_xlat2, 1.0);
    u_xlat0.x = u_xlat1 * u_xlat16_0 + u_xlat2;
#ifdef UNITY_ADRENO_ES3
...
vec4 hlslcc_FragCoord = vec4(gl_FragCoord.xyz, 1.0/gl_FragCoord.w);
    u_xlat0.xy = vs_TEXCOORD1.xy * vec2(3.0, 0.100000001);
    u_xlat0.xy = vec2(_PannerOverTime) * vec2(0.0, -0.100000001) + u_xlat0.xy;
    u_xlat16_0 = texture(_TextureSample0, u_xlat0.xy).x;
    u_xlat3 = (-vs_TEXCOORD1.y) + 1.0;
    u_xlat6 = log2(u_xlat3);
    u_xlat6 = u_xlat6 * 20.6100006;
    u_xlat6 = exp2(u_xlat6);
    u_xlat6 = min(u_xlat6, 1.0);
    u_xlat0.x = u_xlat3 * u_xlat16_0 + u_xlat6;
#ifdef UNITY_ADRENO_ES3
    u_xlat0.x = min(max(u_xlat0.x, 0.0), 1.0);
#else
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
